...
extension TestResultEntity {
    ...
    func toTestResults() -> TestResults {
        return TestResults(
            ...
            serverName: self.serverName ?? "Unknown".localized,
            serverLocation: self.serverLocation ?? "Unknown".localized,
            connectionType: self.connectionType ?? "Unknown".localized,
            providerName: self.providerName ?? "Unknown".localized,
